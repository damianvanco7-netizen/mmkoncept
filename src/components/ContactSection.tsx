      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 max-w-lg">
          ...
          <button
            ...
            className="w-full sm:w-auto rounded-full px-10 py-3.5 text-sm font-semibold tracking-wide transition-all duration-300 liquid-glass-circle text-white disabled:opacity-40 disabled:cursor-not-allowed hover:scale-[1.01]"
          >
