      ...
      <div className="w-full">
            ...
            <div key={step} className="flex flex-col md:flex-row items-center gap-3 md:gap-4">
              ...
              {i < flowSteps.length - 1 && (
                <>
                  ...
                  <ArrowDown className="w-4 h-4 text-warm-taupe md:hidden" />
                </>
              )}
            </div>
          ))}
        ...
        <div className="text-center">
          ...
          <div className="flex items-center justify-center gap-4 md:gap-8 flex-wrap">
            <div className="px-6 md:px-8 py-4 rounded-2xl bg-white/[0.07] border border-white/[0.06] flex items-center gap-3">
