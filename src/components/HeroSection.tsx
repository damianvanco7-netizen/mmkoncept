    ...
    >
      ...
      <button
        ...
        className="absolute z-20 rounded-full flex flex-col items-center justify-center transition-all duration-500 liquid-glass-circle overflow-hidden
          ...
          bottom-[calc(2rem+env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:bottom-[clamp(40px,5vw,80px)] w-[160px] h-[160px] md:w-[clamp(160px,15vw,240px)] md:h-[clamp(160px,15vw,240px)]"
      >
